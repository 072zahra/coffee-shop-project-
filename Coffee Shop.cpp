...
void extro(int a)
{
	...
	cout << "  _____ ______         ____ _____  _____ _______" << endl
         << " / ____|___  /   /\\   |  _ \\_   _|/ ____|__   __|" << endl
         << "| (___    / /   /  \\  | |_) || | | (___    | |  " << endl
         << " \\___ \\  / /   / /\\ \\ |  _ < | |  \\___ \\   | | " << endl
         << " ____) |/ /__ / ____ \\| |_) || |_ ____) |  | |   " << endl
         << "|_____//_____/_/    \\_\\____/_____|_____/   |_|   " << endl;
	cout << endl;
	cout << "\t\t\t\tProject BY:\n\t\t\t\t\t Zain \n\t\t\t\t\t \n\t\t\t\t\t " << endl;
	cout << "\t\t\t\tProject BY:\n\t\t\t\t\t M Anas \n\t\t\t\t\t \n\t\t\t\t\t " << endl;
	cout << "\t\t\t\tProject BY:\n\t\t\t\t\t Zahra \n\t\t\t\t\t \n\t\t\t\t\t " << endl;
	...
	cout << "\t\t\t\tProject BY:\n\t\t\t\t\t  \n\t\t\t\t\t \n\t\t\t\t\t " << endl;
	cout << endl;
	cout << "\t\t\t\tSubmitted TO:\n\t\t\t\t\t Rescpected Ma'am Zoha Irfan" << endl;
	Sleep(130);
	exit(0);
}
			...
			while (true)
			{
				do
				{
					...
					else if (c == 4)
					{
						...
						for (int i = 0;i < a;i++)
						{
							cout << cust.getOrder(i) << "\t\t" << str[b] << "\t\t" 
							<< cust.getPay(i) * str[b] << endl;
